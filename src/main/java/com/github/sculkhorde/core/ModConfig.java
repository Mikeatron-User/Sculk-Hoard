...
public class ModConfig {
    ...
    public static class Server {
        ...
        public Server(ForgeConfigSpec.Builder builder) {
            ...
            max_infestation_cursor_population = builder.comment("How many infestation cursors are allowed to exist at one time. WARNING: This only applies if performance mode is at HIGH. To keep performance at HIGH, set disable_auto_performance_system to true (Default 300)").defineInRange("max_infestation_cursor_population", 300, 1, Integer.MAX_VALUE);
